...
public class ViewAnimator<T extends Resourceble> {
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            View viewMenu = null;
            if (i == 0){
                viewMenu = appCompatActivity.getLayoutInflater().inflate(com.jj.tidedemo.R.layout.menu_list_first_item, null);
            } else {
                viewMenu = appCompatActivity.getLayoutInflater().inflate(com.jj.tidedemo.R.layout.menu_list_item, null);
            }
            final int finalI = i;
            ...
            ((TextView) viewMenu.findViewById(R.id.menu_item_title)).setText(list.get(i).getImageTitle());
